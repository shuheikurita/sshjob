...
sshrun provides easy-access to your servers, HPC clusters via ssh. sshrun doesn't provide the ssh and job-running environment. They should be established before sshrun is introduced.
